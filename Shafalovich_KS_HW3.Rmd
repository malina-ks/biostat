...
# Cреднее значение переменной pedigree
mean_pedigree <- mean(pima$pedigree)

# Cтандартное отклонение переменной pedigree
...
```{r}
hist(pima$glucose, main = "Гистограмма уровня глюкозы", xlab = "Уровень глюкозы", border = "black", col = "green", breaks = 30)
